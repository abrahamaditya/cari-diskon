...
Widget detailTop20PenawaranContent3(BuildContext context, Top20Penawaran data) {
  return Container(
...
Widget filterSukaButton(BuildContext context, String suka) {
  return InkWell(
    onTap: () {
      ...
      BlocProvider.of<FilterTop20Suka>(context).add(suka);
      BlocProvider.of<FilterTop20NameDetail>(context).add("Suka");
    },
    child: Container(
...
Widget filterWaktuButton(BuildContext context, String waktu) {
  return InkWell(
    onTap: () {
      ...
      BlocProvider.of<FilterTop20Waktu>(context).add(waktu);
      BlocProvider.of<FilterTop20NameDetail>(context).add("Waktu");
    },
    child: Container(
      decoration: BoxDecoration(
        color: white,
