...
Widget detailAllPenawaranContent3(BuildContext context, SemuaPenawaran data) {
  return Container(
...
Widget filterSukaButton(BuildContext context, String suka) {
  return InkWell(
    onTap: () {
      ...
      BlocProvider.of<FilterAllSuka>(context).add(suka);
      BlocProvider.of<FilterAllNameDetail>(context).add("Suka");
    },
    child: Container(
...
Widget filterWaktuButton(BuildContext context, String waktu) {
  return InkWell(
    onTap: () {
      ...
      BlocProvider.of<FilterAllWaktu>(context).add(waktu);
      BlocProvider.of<FilterAllNameDetail>(context).add("Waktu");
    },
    child: Container(
      decoration: BoxDecoration(
        color: white,
