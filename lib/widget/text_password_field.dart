...
class InputPasswordField extends StatefulWidget {
  ...
  @override
  State<InputPasswordField> createState() => _InputFieldPasswordState();
}

class _InputFieldPasswordState extends State<InputPasswordField> {
  bool _visible = true;
