...
class ChatReviewBoxSemuaPenawaran extends StatelessWidget {
  final int i;
  final int index;
  final String name;
        ...
        children: [
          ...
          Column(
            ...
            children: [
              ...
              Row(
                children: [
                  BlocBuilder<SukaButtonAll, String>(
                            ...
                            ? InkWell(
                                onTap: () {
                                  ...
                                  semuapenawaran[i].review[index].likeButton =
                                      true;
                                  BlocProvider.of<SukaButtonAll>(context)
                                      .add("Liked!");
                                },
