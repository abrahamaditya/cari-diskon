...
Widget filter1OfKategoriPage(BuildContext context, String state) {
  return Card(
    color: white,
    elevation: 1,
...
void filter2OfKategoriPage(BuildContext context, String state, String name) {
  BlocProvider.of<FilterAllKategori>(context).add(name);
...
Widget filter2OfKategoriPageNonVoid(BuildContext context, String state) {
  return Card(
    color: white,
    elevation: 1,
    clipBehavior: Clip.antiAlias,
...
Widget filter3OfKategoriPage(BuildContext context, String state) {
  return Card(
    color: white,
    elevation: 1,
    clipBehavior: Clip.antiAlias,
        ...
        child: Container(
          ...
          child: Column(
            children: [
              ...
              TextDropdownFormField(
                onChanged: ((dynamic item) {
                  BlocProvider.of<FilterAllToko>(context).add(item);
                  BlocProvider.of<FilterAllButton>(context).add(item);
                }),
                dropdownHeight: Sizes.dp50(context),
                options: [
