...
class InputNameFieldComment extends StatelessWidget {
  String? flag;
  String? placeholder;
  String? initialValue;
        ...
        Container(
          ...
          child: Padding(
            ...
            child: TextFormField(
              ...
              onChanged: (newValue) {
                BlocProvider.of<InitialSaved>(context).add(newValue);
              },
              onSaved: (newValue) {
                BlocProvider.of<InitialSaved>(context).add(newValue!);
              },
              validator: (value) {
                if (value != "") {
                  BlocProvider.of<InitialValidator>(context).add("valid");
                } else {
                  BlocProvider.of<InitialValidator>(context)
                      .add("Inisial salah");
                }
              },
            ),
