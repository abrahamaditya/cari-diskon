...
Widget filter1(BuildContext context, String state) {
  return Card(
    color: white,
    elevation: 1,
            ...
            children: [
              ...
              TextDropdownFormField(
                onChanged: ((dynamic item) {
                  BlocProvider.of<FilterTipe>(context).add(item);
                  BlocProvider.of<FilterButton>(context).add(item);
                }),
        ...
        child: Container(
          ...
          child: Column(
            children: [
              ...
              TextDropdownFormField(
                onChanged: ((dynamic item) {
                  BlocProvider.of<FilterKategori>(context).add(item);
                  BlocProvider.of<FilterButton>(context).add(item);
                }),
                ...
                decoration: InputDecoration(
                  ...
                  // prefix: BlocBuilder<FilterKategori, String>(
        ...
        child: Container(
          ...
          child: Column(
            children: [
              ...
              TextDropdownFormField(
                onChanged: ((dynamic item) {
                  BlocProvider.of<FilterToko>(context).add(item);
                  BlocProvider.of<FilterButton>(context).add(item);
                }),
                dropdownHeight: Sizes.dp50(context),
                options: [
