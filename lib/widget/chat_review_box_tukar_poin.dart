...
class ChatReviewBoxTukarPoin extends StatelessWidget {
  final int i;
  final int index;
  final String name;
        ...
        children: [
          ...
          Column(
            ...
            children: [
              ...
              Row(
                children: [
                  BlocBuilder<SukaButtonTukarPoin, String>(
                            ...
                            ? InkWell(
                                onTap: () {
                                  ...
                                  semuapenawaran[i].review[index].likeButton =
                                      true;
                                  BlocProvider.of<SukaButtonTukarPoin>(context)
                                      .add("Liked!");
                                },
